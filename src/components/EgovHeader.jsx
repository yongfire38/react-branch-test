...
function EgovHeader({ loginUser, onChangeLogin }) {
    ...
    const seeeionUser = sessionStorage.getItem('loginUser');
    const seeeionUserId = JSON.parse(seeeionUser)?.id;
    const seeeionUserName = JSON.parse(seeeionUser)?.name;
        ...
        <div className="header">
            <div className="inner">
                ...
                <div className="user_info">
                    ...
                    {seeeionUserId &&
                        <>
                            <span className="person">{seeeionUserName} </span> 님이, 관리자로 로그인하셨습니다.
            ...
            <div className="all_menu Mobile closed">
                <div className="user_info_m">
                    ...
                    {seeeionUserId &&
                        <>
                            <span className="person">{seeeionUserName} </span>이 로그인하셨습니다.
